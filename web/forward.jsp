...
<body>
	<% 
        ...
        <div id="content1">
            <form action = "forward"  onsubmit="return validate(this);">
                To      <input type="text" name="receiver" value="" />
                Subject <input type="text" name="subject" value="<%=subject%>" readonly="" placeholder="<%=subject%>"/><br>
                <textarea rows="10" cols="102" name="content" readonly="" placeholder="<%=mail_content%>"></textarea>
